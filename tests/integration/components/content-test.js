...
module('Integration | Component | basic-dropdown-content', function(hooks) {
  ...
  //     {{#basic-dropdown/content rootEventType='mousedown' dropdown=dropdown @destination="destination-el">Lorem ipsum</BasicDropdownContent>
  //   `);
  ...
  //     <div id="destination-el"></div>
  //     <div id="other-div"></div>
  //     {{#basic-dropdown/content rootEventType='click' dropdown=dropdown @destination="destination-el">Lorem ipsum</BasicDropdownContent>
  //   `);
  ...
  //   await render(hbs`
  //     <div id="destination-el"></div>
  //     {{#basic-dropdown/content dropdown=dropdown @renderInPlace={{true}} @destination="destination-el">Lorem ipsum</BasicDropdownContent>
  //   `);
  //   run(() => window.dispatchEvent(new window.Event('scroll')));
  //   assert.equal(repositions, 2, 'The component has been repositioned twice');
  // });
