...
import MyCustomTrigger from '../../../demo-app/components/my-custom-trigger';
import MyCustomContent from '../../../demo-app/components/my-custom-content';
import BasicDropdown from '#src/components/basic-dropdown.gts';
import { on } from '@ember/modifier';
import Shadow from '../../../demo-app/components/shadow';
import type { Dropdown, HorizontalPosition } from '#src/types.ts';
import type { CalculatePosition } from '#src/utils/calculate-position.ts';
