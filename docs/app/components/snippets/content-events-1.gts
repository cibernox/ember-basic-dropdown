...
export default class extends Component {
  ...
  @action
  open(dropdown: BasicDropdownDefaultBlock) {
    void this.closeLaterTask.cancelAll();
  ...
  async closeLater(dropdown: BasicDropdownDefaultBlock) {
    try {
      await this.closeLaterTask.perform(dropdown);
    } catch (e) {
      if (!didCancel(e)) {
  ...
  closeLaterTask = task(async (dropdown: BasicDropdownDefaultBlock) => {
    await timeout(200);
        ...
        <div class="demo-fake-notifications">
          <BasicDropdown @horizontalPosition="right" as |dd|>
            ...
            >
              ...
              <span class="demo-fake-notifications-count">
