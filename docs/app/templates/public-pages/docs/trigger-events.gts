...
<template>
  ...
  <CodeExample @glimmerTs="trigger-events-0.gts">
    <TriggerEvents0Component />
  </CodeExample>
  ...
  <CodeExample @glimmerTs="trigger-events-4.gts">
    <TriggerEvents4Component />
  </CodeExample>
