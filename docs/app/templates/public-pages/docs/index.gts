...
<template>
  ...
  <p>
    ...
    <em>why would you want to use a third part addon for such a simple thing?</em>
  </p>

  <p>
    <strong>Well, there are two kinds of people. Those who think that dropdowns
      are an easy thing and those who have actually built one.</strong>
  </p>
  ...
  <ul>
    <li>Absolutely position elements in a performant way using the runloop</li>
    <li>Overcoming z-index limitations</li>
    <li>How useful MutationObservers and DOM Events can be</li>
    <li>Proper detection of taps and touch scroll</li>
    <li>Animating elements being removed from the screen</li>
    <li>Chasing memory leaks when global events are not properly removed</li>
