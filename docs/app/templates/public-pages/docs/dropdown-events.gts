...
<template>
  ...
  <CodeExample @glimmerTs="dropdown-events-1.gts">
    <DropDownEvents1Component />
  </CodeExample>
  ...
  <CodeExample @glimmerTs="dropdown-events-2.gts">
    <DropDownEvents2Component />
  </CodeExample>
