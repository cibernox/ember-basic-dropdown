...
* `ember-basic-dropdown`
  ...
  * [#1032](https://github.com/ember-power-addons/ember-basic-dropdown/pull/1032) Add `@triggerHtmlTag` on `<BasicDropdown>` and remove `@htmlTag` option from yielded trigger component (fix glint v2 issue) ([@mkszepp](https://github.com/mkszepp))
...
#### :rocket: Enhancement
* `ember-basic-dropdown`
  * [#1123](https://github.com/ember-power-addons/ember-basic-dropdown/pull/1123) Add sass/css export into package.json to support scss `pkg:` imports & update dependencies ([@mkszepp](https://github.com/mkszepp))
...
#### :house: Internal
* `ember-basic-dropdown`
  * [#1128](https://github.com/ember-power-addons/ember-basic-dropdown/pull/1128) Add changelog from v8.11.1 ([@mkszepp](https://github.com/mkszepp))
