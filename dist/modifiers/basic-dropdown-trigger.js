...
class DropdownTriggerModifier extends Modifier {
  ...
  setup(element) {
    ...
    this.dropdown?.actions?.registerTriggerElement && this.dropdown.actions.registerTriggerElement(element);
  ...
  handleTouchStart() {
    ...
    if (this.triggerElement?.getRootNode() instanceof ShadowRoot) {
      (this.triggerElement?.getRootNode()).addEventListener('touchmove', this._touchMoveHandler);
    }
  }
  static {
  ...
  _touchMoveHandler(e) {
    ...
    document.removeEventListener('touchmove', this._touchMoveHandler);
    if (this.triggerElement?.getRootNode() instanceof ShadowRoot) {
      (this.triggerElement?.getRootNode()).removeEventListener('touchmove', this._touchMoveHandler);
    }
  }
  static {
...
function cleanup(instance) {
  ...
  if (triggerElement) {
    ...
    if (triggerElement?.getRootNode() instanceof ShadowRoot) {
      (triggerElement?.getRootNode()).removeEventListener('touchmove', instance._touchMoveHandler);
    }
